...
<p> <a href="https://www.facebook.com/profile.php?id=61567037645807" target="_blank"> <i className="fab fa-2x fa-facebook"></i> </a> <a href="https://www.instagram.com/marc.laliberte.photo" target="_blank"> <i className="fab fa-2x fa-instagram"></i> </a> </p> 
...
<form method="post" action="https://formspree.io/f/mjkyajaa" encType="multipart/form-data">
  ...
  <div className="col-sm-12 text-center">
    <button type="submit" className="btn btn-template-main"><i className="far fa-envelope"></i>Send</button>
