...
<ImageModal src={"https://res.cloudinary.com/dbjekf3b7/image/upload/v1772665871/blog/n0pjuwq6tlbwx4zlx2qe.png"} width={"600px"} alt={"Capture d'écran de l'interface de l'application ImageMagick Scripts"} caption={"L'interface actuelle d'ImageMagick Scripts"} />
