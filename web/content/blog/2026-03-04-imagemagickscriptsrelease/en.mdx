...
<ImageModal src={"https://res.cloudinary.com/dbjekf3b7/image/upload/v1772665871/blog/n0pjuwq6tlbwx4zlx2qe.png"} width={"600px"} alt={"Screenshot of the ImageMagick Scripts application interface"} caption={"The current ImageMagick Scripts UI"} />
