...
<ImageModal src={"https://res.cloudinary.com/dbjekf3b7/image/upload/v1751987786/Lightroom_TY0JPyjIvv_rt6syi.png"} width={"600px"} alt={"Image d'un message d'erreur dans Lightroom disant : ./LRMogrifyExportTask.lua:128: attempt to index local 'handle' (a nil value) (2)"} caption={"./LRMogrifyExportTask.lua:128: attempt to index local 'handle' (a nil value) (2)"} />
...
<ImageModal src={"https://res.cloudinary.com/dbjekf3b7/image/upload/v1751992179/ImageMagickScripts.UI_RFpzC305pi_peesra.png"} width={"600px"} alt={"Application WinForm basique utilisant ImageMagick pour le traitement d'images"} caption={"Première ébauche de l'interface de mon application"} />
