...
<ImageModal src={"https://res.cloudinary.com/dbjekf3b7/image/upload/v1751992179/ImageMagickScripts.UI_RFpzC305pi_peesra.png"} width={"600px"} alt={"Basic winform app that uses ImageMagick for image processing"} caption={"The first draft UI for my application"} />
